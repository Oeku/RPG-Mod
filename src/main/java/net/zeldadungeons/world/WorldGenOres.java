...
public class WorldGenOres implements IWorldGenerator {
    ...
    public WorldGenOres() {
	this.oreGenSapphire = new CustomGenMinable(Blockizer.SAPPHIRE_ORE.getDefaultState(), 4, Blocks.STONE.getDefaultState()); //vein size
	...
	case OVERWORLD:
	    genOre(world, random, 2, oreGenSapphire, 0, 16, chunkPos); //spawn chance
	...
	if (world.provider.getDimension() == Dimensionizer.medievalID) {
	    genOre(world, random, 8, oreGenCopper, 50, 180, chunkPos);
	    genOre(world, random, 20, oreGenTin, 50, 180, chunkPos);
