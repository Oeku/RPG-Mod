...
public class ChunkGeneration implements IChunkGenerator {
    ...
    /**
     * Constructor of the Overworld Generator
     * 
     * @param worldIn the world instance that this generator generates in.
     * @param seed the seed used to create Pseudorandom values.
     * @param mapFeaturesEnabledIn 
     * @param generatorOptions
     * 
     * 
     **/
    public ChunkGeneration(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions) {
	{
	    /** set the map generators **/
	...
	//create the perlin noise generators for the height map
    ...
    /**
     * Generate the base terrain in this world. 
     * Step 1: get biomes that can generate
     * Step 2: generate a heightmap for this chunk
     * Step 3: Set Stone(Land)or Water(below sea-level)
     * @param x
     * @param z
     * @param primer
     */
	...
	for (int i = 0; i < 4; ++i) { //execute this 4 times
	    ...
	    for (int l = 0; l < 4; ++l) { //execute this 4 times (16 in one run)
		int i1 = (j + l) * 33; //0, 33, 66, 99
		int j1 = (j + l + 1) * 33; //165, 198, 231, 132
		int k1 = (k + l) * 33;
		int l1 = (k + l + 1) * 33;
