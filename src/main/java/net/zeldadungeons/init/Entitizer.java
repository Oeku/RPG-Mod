...
public class Entitizer {
	...
	public static void registerEntities(RegistryEvent.Register<EntityEntry> event) {
		...
		createBuilder("landamus").entity(EntityLandamus.class).tracker(100, 1, true).build(),
		createBuilder("gorok").entity(EntityGorok.class).tracker(100, 1, true).build(),
		createBuilder("prooper").entity(EntityProoper.class).tracker(100, 1, true).build(),
			
		createBuilder("slingshot_pellet").entity(EntitySlingshotPellet.class).tracker(100, 1, true).build(),
		createBuilder("player_pulling").entity(EntityPlayerPulling.class).tracker(100, 1, false).egg(1, 1).build(), };
